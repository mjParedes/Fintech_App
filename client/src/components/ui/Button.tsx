...
export default function Button({
	...
	const buttonClass = clsx(
		'inline-flex items-center justify-center rounded transition focus:outline-none focus:ring-2 focus:ring-offset-2',
		{
			...
			'text-white900 bg-transparent hover:bg-transparent focus:outline-none focus:outline-none focus:ring-0 active:bg-transparent active:border-none': variant === 'text',
